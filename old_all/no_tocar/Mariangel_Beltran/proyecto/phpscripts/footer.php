...
<footer class="bg-light text-dark pt-5 pb-4">
    <div class="container text-center text-md-start">
        ...
        <div class="collapse" id="collapseExample">
            ...
            <div class="row">
                <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3">
                    ...
                    <hr class="mb-4">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam voluptatum repellendus
                        labore
                        obcaecati, illum fuga nemo adipisci sapiente ratione totam itaque, nam optio. Sint,
                        molestiae?
                        Reiciendis vel optio dolore est.</p>
                </div>

                <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 font-weight-bold text-dark">Ayuda</h5>
                    <hr class="mb-4">
                    <p><a href="#" class="text-dark">Tu cuenta</a></p>
                    <p><a href="#" class="text-dark">Tus juegos</a></p>
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mt-3">
                    ...
                    <hr class="mb-4">
                    <p>
                        <li class="fas fa-home me-3"></li> Bogotá D.C, Colombia
                    </p>
                    <p>
                        <li class="fas fa-envelope me-3"></li> msbeltrand@itc.edu.co
                    </p>
                    <p>
                        <li class="fas fa-phone me-3"></li> +573176062390
                    </p>
                </div>
            </div>
        ...
        <div class="text-center mb-2">
            ...
            <a href="#"><strong class="text-primary">Test</strong></a>
        </div>
